...
d=3000;  %Original upper bound for internal bisection
f=3000;  %Original upper bound for internal bisection
...
for n=1:length(Gamma1)
    ...
    for k=1:20
        ...
        rou_1e=Bisection_256_QAM_23_new(c,d,1e-3,eta,gamma1);
        rou_2e=Bisection_256_QAM_23_new(e,f,1e-3,eta,gamma2);
