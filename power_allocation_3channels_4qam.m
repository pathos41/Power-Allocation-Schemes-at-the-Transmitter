...
d=300;  %Original upper bound for internal bisection
f=300;  %Original upper bound for internal bisection

Gamma1_dB=-20:20;
Gamma2_dB=Gamma1_dB+3;
Gamma3_dB=Gamma2_dB+3;  %xx-fold gain
...
for n=1:length(Gamma1)
    ...
    a=gamma1*MMSE_QPSK(12*gamma1/7);  %Original lower bound
    b=gamma3*MMSE_QPSK(12*gamma1/7);  %Original upper bound
