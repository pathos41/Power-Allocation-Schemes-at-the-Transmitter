...
for n=1:length(Gamma1)
    ...
    a=gamma1*MMSE_64_QAM_23_new(200*gamma1/101);  %Original lower bound for external bisection
    b=gamma2*MMSE_64_QAM_23_new(200*gamma1/101);  %Original upper bound for external bisection
